    ...
    return (
        ...
        <BrowserRouter>
            ...
            <Routes>
                ...
                {/* Define route for the FindADoctorPage component */}
                <Route path="/FindADoctorPage" element={<FindADoctorPage />} />
                {/* Define route for the Formdr component */}
                <Route path="/Formdr" element={<Formdr />} />
                {/* Define route for the FormdrGeneralPhy component */}
                <Route path="/FormdrGeneralPhy" element={<FormdrGeneralPhy />} />
                {/* Define route for the GeneralPhysician component */}
                <Route path="/GeneralPhysician" element={<GeneralPhysician />} />
                {/* Define route for the Homepage component */}
                <Route path="/Homepage" element={<Homepage />} />
                {/* Define route for the Login component */}
                <Route path="/Login" element={<Login />} />
                {/* Define route for the Popup component */}
