...
const GeneralPhysician: React.FC = () => {
    ...
    const handleFindADoctorMouseEnter = () => {
        navigate('/FindADoctorPage');
    };
...
<div className={(styles['class-4']) + " class=Home"} id="120:774" onClick={handleHomeClick}>Home </div><div className={(styles['class-5']) + " class=FindADoctor"} id="120:775" onMouseEnter={handleFindADoctorMouseEnter}>Find a Doctor</div><div className={(styles['class-6']) + " class=MyAppointment"} id="120:776">My Appointment</div>
</div>
...
<img className={(styles['class-53']) + " class=rightarrow"} id="194:165" src={rightarrow_jpg} onClick={handleRightArrowClick}/>
<img className={(styles['class-54']) + " class=rightarrow"} id="194:166" src={rightarrow_jpg} onClick={handleRightArrowClick}/>
<img className={(styles['class-55']) + " class=rightarrow"} id="194:168" src={rightarrow_jpg} onClick={handleRightArrowClick}/>
<img className={(styles['class-56']) + " class=rightarrow"} id="194:167" src={rightarrow_jpg} onClick={handleRightArrowClick}/>
