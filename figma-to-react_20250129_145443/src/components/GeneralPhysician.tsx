...
<div className={(styles['class-4']) + " class=Home"} id="120:774" onClick={() => handleClick('Homepage')}>Home </div><div className={(styles['class-5']) + " class=FindADoctor"} id="120:775" onMouseEnter={() => handleMouseEnter('FindADoctorPage')}>Find a Doctor</div><div className={(styles['class-6']) + " class=MyAppointment"} id="120:776">My Appointment</div>
</div>
