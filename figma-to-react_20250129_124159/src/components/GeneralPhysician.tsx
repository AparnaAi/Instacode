...
<div className={(styles['class-4']) + " class=Home"} id="120:774" onClick={() => navigate('/Homepage')}>Home </div>
<div className={(styles['class-5']) + " class=FindADoctor"} id="120:775" onMouseEnter={()=> navigate('/FindADoctorPage')}>Find a Doctor</div>
...
<img className={(styles['class-53']) + " class=rightarrow"} id="194:165" src={rightarrow_jpg} onClick={() => navigate('/FormdrGeneralPhy')}/>
<img className={(styles['class-54']) + " class=rightarrow"} id="194:166" src={rightarrow_jpg} onClick={() => navigate('/FormdrGeneralPhy')}/>
<img className={(styles['class-55']) + " class=rightarrow"} id="194:168" src={rightarrow_jpg} onClick={() => navigate('/FormdrGeneralPhy')}/>
<img className={(styles['class-56']) + " class=rightarrow"} id="194:167" src={rightarrow_jpg} onClick={() => navigate('/FormdrGeneralPhy')}/>
