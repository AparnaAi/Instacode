...
<div className={(styles['class-4']) + " class=Home"} id="120:774" onClick={() => handleNavigation('Homepage')}>Home </div><div className={(styles['class-5']) + " class=FindADoctor"} id="120:775" onMouseEnter={() => handleNavigation('FindADoctorPage')}>Find a Doctor</div><div className={(styles['class-6']) + " class=MyAppointment"} id="120:776">My Appointment</div>
</div>
